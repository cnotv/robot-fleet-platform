...
| A port, probe, environment variable or resource in a service | `deploy/k8s/base/`, `deploy/vm/compose.vm.yaml`, `docker-compose.yml`, `operations/kubernetes.md`, `operations/vm.md` |
